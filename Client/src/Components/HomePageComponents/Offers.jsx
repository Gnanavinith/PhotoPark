...
import topOffer1 from "../../assets/Offers/Topoffer1.jpg";
import topOffer2 from "../../assets/Offers/Topoffer2.jpg";
import topOffer3 from "../../assets/Offers/Topoffer3.jpg";
import downOffer1 from "../../assets/Offers/Downoffer1.jpg";
import downOffer2 from "../../assets/Offers/Downoffer2.jpg";
import downOffer3 from "../../assets/Offers/Downoffer3.jpg";

const topOffers = [topOffer1, topOffer2, topOffer3];
const downOffers = [downOffer1, downOffer2, downOffer3];
  ...
  return (
    <div className="text-center p-4 mx-4 sm:mx-[5vw] my-10 font-[Poppins]">
      ...
      <p className="text-lg text-gray-700 text-center mb-10 max-w-2xl mx-auto">
        ...
        <span className="font-semibold text-blue-900"> premium acrylic and wooden frames.</span>
