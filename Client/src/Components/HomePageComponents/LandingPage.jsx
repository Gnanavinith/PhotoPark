  ...
  return (
    ...
    <div>
      ...
      <div className="relative w-full h-170 overflow-hidden">
        ...
        <div className="absolute z-10 opacity-75 text-white bg-black border border-1 border-white top-50 w-80 left-8 p-5 w-100 p-10 left-20 top-55 ">

          <div style={{ fontSize: "44px", fontWeight: "bold", color: "white" }}>
            SPECIAL{" "}
