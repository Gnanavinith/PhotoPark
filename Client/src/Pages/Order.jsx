...
const Order = () => {
  ...
  const handleEnquirySubmit = () => {
    ...
    // Handle submission (e.g., send to backend or display confirmation)
    ...
    <div className="min-h-screen pt-16  p-8 bg-white font-[poppins]">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-10">
        ...
        <div className="space-y-4">
          <h2 className="text-3xl font-bold">Landscape FRAME</h2>
          <p className="text-red-600 text-xl font-bold">₹599 <span className="line-through text-gray-400">₹999</span> <span className="text-green-600">Free Shipping</span></p>
          ...
          <div className="p-3 bg-yellow-50 border rounded">
            <p className="text-yellow-800 font-medium">🎁 Complimentary Gift</p>
          ...
          <div className="flex items-center space-x-2">
            ...
            />
             <button className="bg-black text-white px-6 py-2 rounded-lg w-full">Add To Cart</button>
          </div>
        ...
        <div className="bg-gray-50 p-4 rounded-lg shadow space-y-4">
          ...
          <div className="text-sm text-blue-600">
            ...
            <button className="mt-3 bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded w-full">
